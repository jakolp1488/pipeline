...
- __Country/State__ refers to: Alaska,  United States
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in these Terms and Conditions) refers to pipeline.
...
- __Website__ refers to pipeline, accessible from [pipeline.ru](pipeline.ru)
...
- By email: dongmeier2009@jugarmail.com